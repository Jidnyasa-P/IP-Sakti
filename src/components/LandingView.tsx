...
import { Sparkles, FlaskConical, Compass, BookOpen, ArrowRight, ShieldCheck } from 'lucide-react';
...
export const LandingView: React.FC<LandingViewProps> = ({ setActiveTab }) => {
  ...
  return (
    <div className="w-full max-w-7xl xl:max-w-[1440px] 2xl:max-w-[1560px] mx-auto px-4 sm:px-6 lg:px-8 py-8 md:py-12 space-y-12">
      {/* Hero Section */}
          ...
          {capabilities.map((item) => {
            ...
            return (
              <div
                ...
                className="group relative p-6 rounded-2xl transition-all cursor-pointer flex flex-col justify-between bg-emerald-50/35 border border-emerald-200/80 shadow-xs hover:bg-emerald-50/65 hover:border-emerald-300 hover:shadow-md"
              >
                <div>
                  <div className="w-12 h-12 rounded-xl flex items-center justify-center transition-colors mb-4 bg-emerald-100/60 border border-emerald-200/80 text-emerald-800 group-hover:bg-emerald-100 group-hover:text-emerald-900">
                ...
                <div className="mt-5 pt-3 border-t border-emerald-100 flex items-center text-xs font-semibold text-emerald-900 group-hover:text-emerald-950 transition-colors">
