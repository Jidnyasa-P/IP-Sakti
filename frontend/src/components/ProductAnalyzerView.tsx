...
export const ProductAnalyzerView: React.FC<ProductAnalyzerViewProps> = ({
  onOpenCitation,
  onSaveToWorkspace,
}) => {
  ...
  const [formData, setFormData] = useState<ProductInformation>({
    ...
    dosage_form: "Capsule",
    manufacturing_info:
      "Domestic licensed manufacturing facility (Schedule T compliant)",
    ingredients: "",
    classical_reference: "",
    ...
    distribution_channels:
      "Pharmacies, Ayurvedic dispensaries, Online e-commerce",
  });
  ...
  const loadPreset = (presetNumber: number) => {
    if (presetNumber === 1) {
      setFormData({
        ...
        manufacturing_info:
          "Contract manufacturing under State AYUSH GMP certification",
        ingredients:
          "Standardized Withania somnifera (Ashwagandha) root extract (5% Withanolides) - 300mg, Curcuma longa (Haridra) rhizome extract (95% Curcuminoids) - 200mg, Piper nigrum (Maricha) extract - 5mg",
        classical_reference: "",
        biological_source_details:
          "Withania somnifera cultivated in Madhya Pradesh; Curcuma longa cultivated in Kerala. Certificate of origin available from suppliers.",
        intended_use:
          "Management of inflammatory joint pain, stiffness, and chronic musculoskeletal discomfort",
        claims:
          "Clinically proven synergistic anti-inflammatory action; 3x higher bioavailability than individual extracts",
        target_symptoms:
          "Joint stiffness, osteoarthritis discomfort, cartilage inflammation",
        target_market: "Both",
        distribution_channels:
          "Specialty AYUSH clinics, nutraceutical retailers, and cross-border e-commerce",
      });
      ...
      setFormData({
        ...
        manufacturing_info:
          "Internal dedicated Ayurvedic pharmaceutical facility",
        ingredients:
          "Emblica officinalis (Amalaki), Withania somnifera, Asparagus racemosus (Shatavari), Pippali, Clarified Butter (Ghee), Honey, Sesamum indicum oil, and Dashamoola herbs",
        classical_reference:
          "Charaka Samhita, Chikitsa Sthana, Chapter 1, Rasayana Adhyaya (First Schedule of Drugs & Cosmetics Act, 1940)",
        biological_source_details:
          "Wild-harvested Emblica officinalis from central Indian forests; Dashamoola roots procured via local Biodiversity Management Committees (BMCs)",
        intended_use:
          "Rasayana rejuvenation, immunity modulation, respiratory vitality",
        claims:
          "Traditional classical Ayurvedic Rasayana formulation conforming strictly to Charaka Samhita",
        target_symptoms:
          "General debility, low immunity, seasonal respiratory infections",
      ...
      setFormData({
        ...
        ingredients:
          "Equal parts aqueous extracts of Terminalia chebula (Haritaki), Terminalia bellirica (Bibhitaki), and Emblica officinalis (Amalaki) with food-grade citric acid and sodium bicarbonate",
        classical_reference: "Sushruta Samhita, Sutrasthana, Triphala group",
        biological_source_details:
          "Botanicals sourced from local farmer cooperatives in Maharashtra (commercially cultivated)",
        intended_use:
          "Daily digestive balance and gut motility support as dietary food supplement",
        claims:
          "Promotes natural digestion and regularity without medicinal disease claims",
        target_symptoms: "Occasional digestive sluggishness",
        target_market: "Both",
        distribution_channels:
          "Supermarkets, health food stores, modern retail",
      });
    }
  };
    ...
    <div className="w-full px-3 sm:px-5 lg:px-6 py-6 sm:py-8 space-y-6 sm:space-y-8">
      ...
      <div className="space-y-2">
        ...
        <p className="text-sm text-slate-600 max-w-3xl">
          {t(
            "product.subtitle",
            "Evaluate AYUSH formulations against the Drugs and Cosmetics Act (Schedule T & Rule 158-B), FSSAI Ayurveda Aahar regulations, Indian Patents Act Section 3(p)/3(e), and National Biodiversity Authority ABS requirements.",
          )}
        </p>
      </div>
      {error && (
      ...
      {step < 5 && (
        ...
        >
          <div className="text-xs text-slate-600 font-medium">
            <span className="font-semibold text-slate-900">Quick Test:</span>{" "}
            Load an authoritative product profile:
          </div>
      ...
      {/* Step Forms */}
      <div
        id="product-analyzer-form-card"
        className="bg-white rounded-2xl border border-slate-200 p-4 sm:p-6 md:p-8 shadow-xs"
      >
        {step === 1 && (
              ...
              <div className="space-y-1.5">
                ...
                <input
                  ...
                  onChange={(e) =>
                    setFormData({
                      ...formData,
                      manufacturing_info: e.target.value,
                    })
                  }
                  className="w-full px-3.5 py-2 text-sm rounded-lg border border-slate-300 focus:ring-1 focus:ring-emerald-700 focus:outline-hidden"
                />
        ...
        {step === 2 && (
          <div className="space-y-6 animate-in fade-in duration-200">
            ...
            <div className="space-y-4">
              ...
              <div className="space-y-1.5">
                ...
                <input
                  ...
                  onChange={(e) =>
                    setFormData({
                      ...formData,
                      classical_reference: e.target.value,
                    })
                  }
                  className="w-full px-3.5 py-2 text-sm rounded-lg border border-slate-300 focus:ring-1 focus:ring-emerald-700 focus:outline-hidden"
                />
                <span className="text-[11px] text-slate-500">
                  Must be one of the 54 authoritative texts listed in the First
              ...
              <div className="space-y-1.5">
                <label className="text-xs font-semibold text-slate-700">
                  Biological Resource Origin & Provenance Details (NBA/SBB
                  compliance)
                </label>
                <textarea
                  rows={2}
                  ...
                  onChange={(e) =>
                    setFormData({
                      ...formData,
                      biological_source_details: e.target.value,
                    })
                  }
                  className="w-full px-3.5 py-2 text-sm rounded-lg border border-slate-300 focus:ring-1 focus:ring-emerald-700 focus:outline-hidden"
                />
            ...
            <div className="space-y-4">
              <div className="space-y-1.5">
                ...
                <textarea
                  ...
                  onChange={(e) =>
                    setFormData({ ...formData, intended_use: e.target.value })
                  }
                  className="w-full px-3.5 py-2 text-sm rounded-lg border border-slate-300 focus:ring-1 focus:ring-emerald-700 focus:outline-hidden"
                />
              </div>
              ...
              <div className="space-y-1.5">
                ...
                <textarea
                  ...
                  onChange={(e) =>
                    setFormData({ ...formData, claims: e.target.value })
                  }
                  className="w-full px-3.5 py-2 text-sm rounded-lg border border-slate-300 focus:ring-1 focus:ring-emerald-700 focus:outline-hidden"
                />
                <span className="text-[11px] text-slate-500">
                  Note: Claims to "cure" diseases listed in Schedule J of Drugs
                  & Cosmetics Rules are strictly prohibited.
                </span>
              </div>
            </div>
        ...
        {step === 4 && (
          <div className="space-y-6 animate-in fade-in duration-200">
              ...
              <div className="space-y-1.5">
                ...
                <select
                  ...
                  onChange={(e) =>
                    setFormData({
                      ...formData,
                      target_market: e.target.value as any,
                    })
                  }
                  className="w-full px-3.5 py-2 text-sm rounded-lg border border-slate-300 focus:ring-1 focus:ring-emerald-700 focus:outline-hidden bg-white"
                >
              ...
              <div className="space-y-1.5">
                ...
                <input
                  ...
                  onChange={(e) =>
                    setFormData({
                      ...formData,
                      distribution_channels: e.target.value,
                    })
                  }
                  className="w-full px-3.5 py-2 text-sm rounded-lg border border-slate-300 focus:ring-1 focus:ring-emerald-700 focus:outline-hidden"
                />
            ...
            <div className="p-4 rounded-xl bg-emerald-50/70 border border-emerald-200/80 text-xs text-emerald-950 flex items-start gap-2.5">
              ...
              <p>
                Ready to analyze against authoritative repositories. The AI will
                evaluate patentability hurdles under Section 3(p)/3(e),
                regulatory licensing pathways under the Drugs & Cosmetics Act,
                and mandatory NBA approvals.
              </p>
            </div>
          ...
          <div className="space-y-8 animate-in fade-in duration-300">
            ...
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 border-b border-slate-200 pb-4">
              ...
              <div className="flex flex-wrap items-center gap-2">
                ...
                >
                  ...
                  <span>
                    {savedSuccess ? "Saved to Workspace!" : "Save Dossier"}
                  </span>
                </button>
            ...
            <div className="p-4 sm:p-6 rounded-2xl bg-white border border-slate-200 shadow-xs space-y-3">
              ...
              <div className="text-[11px] text-slate-400 italic">
                * Note: Category determination is an AI-assisted analytical
                finding for decision support and does not replace formal
                licensing from the State AYUSH Licensing Authority.
              </div>
            </div>
              ...
              <div className="space-y-3 text-xs">
                <div className="p-3.5 rounded-xl bg-amber-50/70 border border-amber-200 text-amber-950 space-y-1">
                  ...
                  <p className="leading-relaxed">
                    {result.ipr_considerations.patent_assessment}
                  </p>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                  <div className="p-3.5 rounded-xl bg-slate-50 border border-slate-200 space-y-1">
                    <span className="font-bold text-slate-900 block">
                      Trademark Protection (Class 5/Class 3)
                    </span>
                    <p className="text-slate-600 leading-relaxed">
                      {result.ipr_considerations.trademark_recommendation}
                    </p>
                  </div>
                  <div className="p-3.5 rounded-xl bg-slate-50 border border-slate-200 space-y-1">
                    <span className="font-bold text-slate-900 block">
                    ...
                    <p className="text-slate-600 leading-relaxed">
                      {result.ipr_considerations.industrial_design}
                    </p>
                    <p className="text-slate-600 leading-relaxed">
                      {result.ipr_considerations.trade_secret_potential}
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="space-y-2 text-xs">
                <div className="flex items-center gap-2">
                  <span className="font-semibold text-slate-700">
                    TK Prior Art Risk Level:
                  </span>
                  <span
                    className={`px-2 py-0.5 rounded font-bold ${
                      result.traditional_knowledge_abs_flags
                ...
                <div className="p-3 rounded-lg bg-slate-50 border border-slate-200 text-slate-700">
                  <strong>NBA / SBB Statutory Filing:</strong>{" "}
                  {result.traditional_knowledge_abs_flags.nba_abs_requirements}
                </div>
              </div>
            </div>
