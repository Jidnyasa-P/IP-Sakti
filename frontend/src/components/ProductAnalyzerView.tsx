...
export const ProductAnalyzerView: React.FC<ProductAnalyzerViewProps> = ({ onOpenCitation, onSaveToWorkspace }) => {
  ...
  return (
    <div className="w-full px-3 sm:px-5 lg:px-6 py-6 sm:py-8 space-y-6 sm:space-y-8">
      ...
      {step < 5 && (
        <div id="product-analyzer-presets" className="p-4 rounded-xl bg-slate-50 border border-slate-200 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3">
      ...
      {/* Step Forms */}
      <div id="product-analyzer-form-card" className="bg-white rounded-2xl border border-slate-200 p-4 sm:p-6 md:p-8 shadow-xs">
        {step === 1 && (
